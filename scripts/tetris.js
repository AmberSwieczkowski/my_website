document.addEventListener('DOMContentLoaded', () => {
    ...
    let nextRandom = 0
    const colors = [
      'url(/images/tetris/blue_block.png)',
      'url(/images/tetris/pink_block.png)',
      'url(/images/tetris/purple_block.png)',
      'url(/images/tetris/peach_block.png)',
      'url(/images/tetris/yellow_block.png)'
    ]
